...
urlpatterns = [
    ...
    path('gemba/gemba-service/deleted-gemba-service/',views.read_deleted_gemba_service, name="deleted-gemba-service"),
    ...
    # urls for GEMBA ITEM
    path('gemba/gemba-service/<gemba_service_id>/gemba-item/deleted-gemba-gemba-item/',views.read_deleted_gemba_item, name="deleted-gemba-item"),
    ...
    path('gemba/gemba-actions/',views.read_gemba_actions, name="gemba-actions"),
